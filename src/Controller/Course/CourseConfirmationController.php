...
class CourseConfirmationController extends AbstractController
{
    public function __construct(protected CoursesRepository $coursesRepository, protected EntityManagerInterface $em) {}

    #[IsGranted('ROLE_USER')]
    #[Route('/course/confirmation/{id}', name: 'app_course_confirmation')]
    public function index($id, Request $request, LessonRepository $lessonRepository): Response
    {
        /** @var User */
        $user = $this->getUser();
